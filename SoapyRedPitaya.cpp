...
public:
    SoapyRedPitaya(const SoapySDR::Kwargs &args):
        _addr("192.168.88.24"), _port(1001)
    {
        size_t i;
    ...
    {
	SoapySDR_log(SOAPY_SDR_INFO, "SoapyRedpitaya::setFrequency called");
    ...
    {
         SoapySDR_log(SOAPY_SDR_INFO, "SoapyRedpitaya::setSampleRate called");
	uint32_t command = 0;

        if(48000 == rate) command = 1;
        else if(96000 == rate) command = 2;
        else if(192000 == rate) command = 3;
        else if(384000 == rate) command = 4;
        else if(768000 == rate) command = 5;
        else if(1536000 == rate) command = 6;
